...
Partial Class Form3
	...
	Private Sub InitializeComponent()
		...
		LabelJudulBayar = New Label()
		LabelKodeBayar = New Label()
		txtKodePembayaran = New TextBox()
		LabelReservasiBayar = New Label()
		cbKodeReservasi = New ComboBox()
		LabelTanggalBayar = New Label()
		dtpTanggalBayar = New DateTimePicker()
		LabelMetodeBayar = New Label()
		cbMetodeBayar = New ComboBox()
		LabelJumlahBayar = New Label()
		txtJumlahBayar = New TextBox()
		LabelStatusBayar = New Label()
		cbStatusBayar = New ComboBox()
		btnTambah4 = New Button()
		btnUbah4 = New Button()
		btnHapus4 = New Button()
		btnReset4 = New Button()
		btnCetakBayar = New Button()
		txtCariPembayaran = New TextBox()
		...
		' TabPage4
		' 
		TabPage4.BackColor = Color.FromArgb(CByte(243), CByte(238), CByte(241))
		TabPage4.Controls.Add(LabelJudulBayar)
		TabPage4.Controls.Add(LabelKodeBayar)
		TabPage4.Controls.Add(txtKodePembayaran)
		TabPage4.Controls.Add(LabelReservasiBayar)
		TabPage4.Controls.Add(cbKodeReservasi)
		TabPage4.Controls.Add(LabelTanggalBayar)
		TabPage4.Controls.Add(dtpTanggalBayar)
		TabPage4.Controls.Add(LabelMetodeBayar)
		TabPage4.Controls.Add(cbMetodeBayar)
		TabPage4.Controls.Add(LabelJumlahBayar)
		TabPage4.Controls.Add(txtJumlahBayar)
		TabPage4.Controls.Add(LabelStatusBayar)
		TabPage4.Controls.Add(cbStatusBayar)
		TabPage4.Controls.Add(btnTambah4)
		TabPage4.Controls.Add(btnUbah4)
		TabPage4.Controls.Add(btnHapus4)
		TabPage4.Controls.Add(btnReset4)
		TabPage4.Controls.Add(btnCetakBayar)
		TabPage4.Controls.Add(txtCariPembayaran)
		TabPage4.Controls.Add(dgvPembayaran)
		TabPage4.Location = New Point(4, 34)
		TabPage4.Name = "TabPage4"
		TabPage4.Padding = New Padding(3)
		TabPage4.Size = New Size(742, 562)
		TabPage4.TabIndex = 3
		TabPage4.Text = "Pembayaran"
		' 
		' LabelJudulBayar
		' 
		LabelJudulBayar.AutoSize = True
		LabelJudulBayar.Font = New Font("Helvetica", 13.9999981F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
		LabelJudulBayar.Location = New Point(228, 20)
		LabelJudulBayar.Name = "LabelJudulBayar"
		LabelJudulBayar.Size = New Size(287, 32)
		LabelJudulBayar.TabIndex = 0
		LabelJudulBayar.Text = "Tambah Pembayaran"
		' 
		' LabelKodeBayar
		' 
		LabelKodeBayar.AutoSize = True
		LabelKodeBayar.Location = New Point(68, 68)
		LabelKodeBayar.Name = "LabelKodeBayar"
		LabelKodeBayar.Size = New Size(155, 25)
		LabelKodeBayar.TabIndex = 1
		LabelKodeBayar.Text = "Kode Pembayaran"
		' 
		' txtKodePembayaran
		' 
		txtKodePembayaran.Location = New Point(68, 96)
		txtKodePembayaran.Name = "txtKodePembayaran"
		txtKodePembayaran.Size = New Size(263, 31)
		txtKodePembayaran.TabIndex = 2
		' 
		' LabelReservasiBayar
		' 
		LabelReservasiBayar.AutoSize = True
		LabelReservasiBayar.Location = New Point(68, 140)
		LabelReservasiBayar.Name = "LabelReservasiBayar"
		LabelReservasiBayar.Size = New Size(130, 25)
		LabelReservasiBayar.TabIndex = 3
		LabelReservasiBayar.Text = "Kode Reservasi"
		' 
		' cbKodeReservasi
		' 
		cbKodeReservasi.DropDownStyle = ComboBoxStyle.DropDownList
		cbKodeReservasi.FormattingEnabled = True
		cbKodeReservasi.Location = New Point(68, 168)
		cbKodeReservasi.Name = "cbKodeReservasi"
		cbKodeReservasi.Size = New Size(263, 33)
		cbKodeReservasi.TabIndex = 4
		' 
		' LabelTanggalBayar
		' 
		LabelTanggalBayar.AutoSize = True
		LabelTanggalBayar.Location = New Point(68, 214)
		LabelTanggalBayar.Name = "LabelTanggalBayar"
		LabelTanggalBayar.Size = New Size(121, 25)
		LabelTanggalBayar.TabIndex = 5
		LabelTanggalBayar.Text = "Tanggal Bayar"
		' 
		' dtpTanggalBayar
		' 
		dtpTanggalBayar.Format = DateTimePickerFormat.Short
		dtpTanggalBayar.Location = New Point(68, 242)
		dtpTanggalBayar.Name = "dtpTanggalBayar"
		dtpTanggalBayar.Size = New Size(263, 31)
		dtpTanggalBayar.TabIndex = 6
		' 
		' LabelMetodeBayar
		' 
		LabelMetodeBayar.AutoSize = True
		LabelMetodeBayar.Location = New Point(356, 68)
		LabelMetodeBayar.Name = "LabelMetodeBayar"
		LabelMetodeBayar.Size = New Size(122, 25)
		LabelMetodeBayar.TabIndex = 7
		LabelMetodeBayar.Text = "Metode Bayar"
		' 
		' cbMetodeBayar
		' 
		cbMetodeBayar.DropDownStyle = ComboBoxStyle.DropDownList
		cbMetodeBayar.FormattingEnabled = True
		cbMetodeBayar.Items.AddRange(New Object() {"Tunai", "Transfer Bank", "QRIS"})
		cbMetodeBayar.Location = New Point(356, 96)
		cbMetodeBayar.Name = "cbMetodeBayar"
		cbMetodeBayar.Size = New Size(320, 33)
		cbMetodeBayar.TabIndex = 8
		' 
		' LabelJumlahBayar
		' 
		LabelJumlahBayar.AutoSize = True
		LabelJumlahBayar.Location = New Point(356, 140)
		LabelJumlahBayar.Name = "LabelJumlahBayar"
		LabelJumlahBayar.Size = New Size(115, 25)
		LabelJumlahBayar.TabIndex = 9
		LabelJumlahBayar.Text = "Jumlah Bayar"
		' 
		' txtJumlahBayar
		' 
		txtJumlahBayar.Location = New Point(356, 168)
		txtJumlahBayar.Name = "txtJumlahBayar"
		txtJumlahBayar.ReadOnly = True
		txtJumlahBayar.Size = New Size(320, 31)
		txtJumlahBayar.TabIndex = 10
		' 
		' LabelStatusBayar
		' 
		LabelStatusBayar.AutoSize = True
		LabelStatusBayar.Location = New Point(356, 214)
		LabelStatusBayar.Name = "LabelStatusBayar"
		LabelStatusBayar.Size = New Size(60, 25)
		LabelStatusBayar.TabIndex = 11
		LabelStatusBayar.Text = "Status"
		' 
		' cbStatusBayar
		' 
		cbStatusBayar.DropDownStyle = ComboBoxStyle.DropDownList
		cbStatusBayar.FormattingEnabled = True
		cbStatusBayar.Items.AddRange(New Object() {"Lunas", "Belum Lunas"})
		cbStatusBayar.Location = New Point(356, 242)
		cbStatusBayar.Name = "cbStatusBayar"
		cbStatusBayar.Size = New Size(320, 33)
		cbStatusBayar.TabIndex = 12
		' 
		' btnTambah4
		' 
		btnTambah4.BackColor = Color.FromArgb(CByte(194), CByte(220), CByte(128))
		btnTambah4.FlatAppearance.BorderColor = Color.FromArgb(CByte(225), CByte(220), CByte(128))
		btnTambah4.FlatStyle = FlatStyle.Flat
		btnTambah4.Location = New Point(68, 285)
		btnTambah4.Name = "btnTambah4"
		btnTambah4.Size = New Size(100, 34)
		btnTambah4.TabIndex = 15
		btnTambah4.Text = "Tambah"
		btnTambah4.UseVisualStyleBackColor = False
		' 
		' btnUbah4
		' 
		btnUbah4.BackColor = Color.FromArgb(CByte(194), CByte(220), CByte(128))
		btnUbah4.FlatAppearance.BorderColor = Color.FromArgb(CByte(225), CByte(220), CByte(128))
		btnUbah4.FlatStyle = FlatStyle.Flat
		btnUbah4.Location = New Point(182, 285)
		btnUbah4.Name = "btnUbah4"
		btnUbah4.Size = New Size(100, 34)
		btnUbah4.TabIndex = 16
		btnUbah4.Text = "Ubah"
		btnUbah4.UseVisualStyleBackColor = False
		' 
		' btnHapus4
		' 
		btnHapus4.BackColor = Color.FromArgb(CByte(194), CByte(220), CByte(128))
		btnHapus4.FlatAppearance.BorderColor = Color.FromArgb(CByte(225), CByte(220), CByte(128))
		btnHapus4.FlatStyle = FlatStyle.Flat
		btnHapus4.Location = New Point(296, 285)
		btnHapus4.Name = "btnHapus4"
		btnHapus4.Size = New Size(100, 34)
		btnHapus4.TabIndex = 17
		btnHapus4.Text = "Hapus"
		btnHapus4.UseVisualStyleBackColor = False
		' 
		' btnReset4
		' 
		btnReset4.BackColor = Color.FromArgb(CByte(194), CByte(220), CByte(128))
		btnReset4.FlatAppearance.BorderColor = Color.FromArgb(CByte(225), CByte(220), CByte(128))
		btnReset4.FlatStyle = FlatStyle.Flat
		btnReset4.Location = New Point(410, 285)
		btnReset4.Name = "btnReset4"
		btnReset4.Size = New Size(100, 34)
		btnReset4.TabIndex = 18
		btnReset4.Text = "Batal"
		btnReset4.UseVisualStyleBackColor = False
		' 
		' btnCetakBayar
		' 
		btnCetakBayar.BackColor = Color.FromArgb(CByte(194), CByte(220), CByte(128))
		btnCetakBayar.FlatAppearance.BorderColor = Color.FromArgb(CByte(225), CByte(220), CByte(128))
		btnCetakBayar.FlatStyle = FlatStyle.Flat
		btnCetakBayar.Location = New Point(524, 285)
		btnCetakBayar.Name = "btnCetakBayar"
		btnCetakBayar.Size = New Size(152, 34)
		btnCetakBayar.TabIndex = 19
		btnCetakBayar.Text = "Cetak Struk"
		btnCetakBayar.UseVisualStyleBackColor = False
		' 
		' txtCariPembayaran
		' 
		txtCariPembayaran.Location = New Point(68, 335)
		txtCariPembayaran.Name = "txtCariPembayaran"
		txtCariPembayaran.PlaceholderText = "Cari Pembayaran..."
		txtCariPembayaran.Size = New Size(606, 31)
		txtCariPembayaran.TabIndex = 20
		' 
		' dgvPembayaran
		' 
		dgvPembayaran.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize
		dgvPembayaran.Location = New Point(68, 372)
		...
		dgvPembayaran.Size = New Size(606, 90)
		dgvPembayaran.TabIndex = 21
		' 
		' Label1
		' 
		...
		dtpTanggal.Location = New Point(69, 236)
		dtpTanggal.Name = "dtpTanggal"
		dtpTanggal.Size = New Size(263, 31)
		dtpTanggal.TabIndex = 41
		' 
		' Form3
		' 
	...
	Friend WithEvents LabelJudulBayar As Label
	Friend WithEvents LabelKodeBayar As Label
	Friend WithEvents txtKodePembayaran As TextBox
	Friend WithEvents LabelReservasiBayar As Label
	Friend WithEvents cbKodeReservasi As ComboBox
	Friend WithEvents LabelTanggalBayar As Label
	Friend WithEvents dtpTanggalBayar As DateTimePicker
	Friend WithEvents LabelMetodeBayar As Label
	Friend WithEvents cbMetodeBayar As ComboBox
	Friend WithEvents LabelJumlahBayar As Label
	Friend WithEvents txtJumlahBayar As TextBox
	Friend WithEvents LabelStatusBayar As Label
	Friend WithEvents cbStatusBayar As ComboBox
	Friend WithEvents btnTambah4 As Button
	Friend WithEvents btnUbah4 As Button
	Friend WithEvents btnHapus4 As Button
	Friend WithEvents btnReset4 As Button
	Friend WithEvents btnCetakBayar As Button
	Friend WithEvents txtCariPembayaran As TextBox
