Module ValidationModule
    ...
    Public Function ValidasiDataPembayaran(ep As ErrorProvider,
                                           txtKode As TextBox,
                                           cbReservasi As ComboBox,
                                           cbMetode As ComboBox,
                                           txtJumlah As TextBox,
                                           cbStatus As ComboBox) As Boolean
        Dim kodeValid As Boolean = ValidasiTextBox(ep, txtKode, "Kode Pembayaran wajib diisi!")
        Dim reservasiValid As Boolean = ValidasiComboBox(ep, cbReservasi, "Silakan pilih kode reservasi!")
        Dim metodeValid As Boolean = ValidasiComboBox(ep, cbMetode, "Silakan pilih metode pembayaran!")
        Dim jumlahValid As Boolean = ValidasiTextBox(ep, txtJumlah, "Jumlah bayar wajib diisi!")
        Dim statusValid As Boolean = ValidasiComboBox(ep, cbStatus, "Silakan pilih status pembayaran!")
        Return kodeValid And reservasiValid And metodeValid And jumlahValid And statusValid
    End Function
